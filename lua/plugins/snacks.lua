...
return {
  {
    ...
    opts = {
      ...
      image = {
        ...
        force = false, -- Prova a visualizzare l'immagine anche se il terminale non supporta il formato
        doc = {
          enabled = true, -- Abilita la visualizzazione delle immagini nei documenti
          inline = true, -- Visualizza l'immagine inline nel buffer
          float = true, -- Visualizza l'immagine in una finestra fluttuante
          max_width = 80,
          max_height = 40,
          conceal = false, -- Nasconde il testo dell'immagine quando è renderizzata inline
        },
        ...
        env = {},
        convert = {
          notify = true, -- Mostra una notifica in caso di errore
          magick = {
            default = { "{src}[0]", "-scale", "1920x1080>" }, -- Configurazione predefinita per immagini raster
            vector = { "-density", 192, "{src}[0]" }, -- Configurazione per immagini vettoriali come SVG
            math = { "-density", 192, "{src}[0]", "-trim" },
            pdf = { "-density", 192, "{src}[0]", "-background", "white", "-alpha", "remove", "-trim" },
          },
        },
        math = {
          enabled = true, -- Abilita la renderizzazione delle espressioni matematiche
          typst = {
            tpl = [[
...
╚═╝      ╚═╝     ╚═╝╚═╝  ╚═╝ ╚═════╝  ╚═════╝ ╚══════╝╚═╝
  ...
  -- -- Keybind per aprire la dashboard manualmente
  -- vim.keymap.set("n", "<leader>sd", function()
  --   require("snacks").dashboard.open() -- Sostituisci con la funzione corretta se diversa
  -- end, { desc = "[S]how [D]ashboard" }),
}
